...
# DESCRIPTION:
# ====================================
# This tool is used to generate a hash over the Adamsbridge source code files
...
#   path_to_rtl_src_dir     Path to the root directory of the adamsbridge RTL repo.
...
if [ $# -ne 2 ]
  then
    echo "Usage: $(basename $0) <path_to_adamsbridge_root> <file_list>"
	exit -1
fi
