...
package fv_ntt_ctrl_pwm_intt_pkg;


typedef enum logic unsigned [1:0] { PwmInttReadIdle, PwmInttReadStage, PwmInttReadExec } e_PwmInttReadStatesType;

typedef enum logic unsigned [2:0] { PwmInttWriteIdle, PwmInttWriteStage, PwmInttWriteBuf, PwmInttWriteMem, PwmInttWriteWait } e_PwmInttWriteStatesType;
