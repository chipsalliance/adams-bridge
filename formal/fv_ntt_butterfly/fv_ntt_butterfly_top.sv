...
module fv_ntt_butterfly_top

import ntt_defines_pkg::*;
import fv_ntt_butterfly_functions::*;
...
fv_ntt_butterfly_constraints fv_constraints_i(.*);

endmodule

bind ntt_butterfly fv_ntt_butterfly_top fv_ntt_butterfly_i(
    .pi_clk (clk),
