...
module fv_ntt_masked_butterfly1x2_top
...
fv_ntt_masked_butterfly1x2_constraints fv_constraints_i(.*);

endmodule

bind ntt_masked_butterfly1x2 fv_ntt_masked_butterfly1x2_top fv_ntt_masked_butterfly1x2_i(
    .pi_clk (clk),
