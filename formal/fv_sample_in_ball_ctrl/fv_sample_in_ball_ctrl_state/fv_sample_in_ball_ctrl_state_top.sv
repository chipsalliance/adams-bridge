...
module fv_sample_in_ball_ctrl_state_top
...
#(
    ...
    fv_sample_in_ball_ctrl_state_constraints #(
...
bind sample_in_ball_ctrl fv_sample_in_ball_ctrl_state_top fv_sample_in_ball_ctrl_i2(
    //#$bind
    .pi_clk (clk),
    .pi_rst_b (rst_b),
    .pi_zeroize (zeroize),
