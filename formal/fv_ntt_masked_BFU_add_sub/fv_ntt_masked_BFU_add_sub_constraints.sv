...
module fv_ntt_masked_BFU_add_sub_constraints
...
property stable_sub;
    $stable(pi_sub);
endproperty
assume_stable_sub: assume property(disable iff (!pi_reset_n) stable_sub);

//Constraint to limit the input value to Q (8380417)
property rnd_q;
    ntt_masked_BFU_add_sub.u[0] + ntt_masked_BFU_add_sub.u[1]  < 'h7FE001 &&
    ntt_masked_BFU_add_sub.v[0] + ntt_masked_BFU_add_sub.v[1] < 'h7FE001
    ;
endproperty
