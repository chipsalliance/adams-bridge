...
module fv_ntt_masked_BFU_add_sub_top
...
fv_ntt_masked_BFU_add_sub_constraints fv_constraints_i(.*);

endmodule

bind ntt_masked_BFU_add_sub fv_ntt_masked_BFU_add_sub_top fv_ntt_masked_BFU_add_sub_i(
    .pi_clk (clk),
