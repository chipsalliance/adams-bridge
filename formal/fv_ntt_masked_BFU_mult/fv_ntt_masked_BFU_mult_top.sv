...
module fv_ntt_masked_BFU_mult_top
...
fv_ntt_masked_BFU_mult_constraints fv_constraints_i(.*);

endmodule

bind ntt_masked_BFU_mult fv_ntt_masked_BFU_mult_top fv_ntt_masked_BFU_mult_i(
    .pi_clk (clk),
