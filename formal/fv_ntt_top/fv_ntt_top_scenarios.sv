...
`ifdef S0
    assume_mode_ct_only: assume property (mode_allowed(ct));
    assume_no_masking: assume property (!pi_masking_en);
    assume_no_shuffle: assume property (!pi_shuffle_en);
`endif
