...
module fv_ntt_ctrl_ct_mode_ref_wrapper_m;
...
fv_ntt_ctrl_ct_mode_m fv_ntt_ctrl_ct_mode(
  .rst((!ntt_ctrl.reset_n || ntt_ctrl.zeroize)),
  .clk(ntt_ctrl.clk),
...
bind ntt_ctrl fv_ntt_ctrl_ct_mode_ref_wrapper_m fv_ntt_ctrl_ct_mode_ref_wrapper();
