...
module fv_ntt_ctrl_ct_mode_aip
...
fv_ntt_ctrl_ct_mode_additional_property #(
    .REG_SIZE(REG_SIZE),
        .RADIX(RADIX),
        .MLDSA_Q(MLDSA_Q),
        .MLDSA_Q_DIV2_ODD(MLDSA_Q_DIV2_ODD),
...
bind ntt_ctrl fv_ntt_ctrl_ct_mode_aip ntt_ctrl_ct_mode_aip_i(
    //#$bind
    .pi_clk (clk),
    .pi_reset_n (reset_n),
    .pi_zeroize (zeroize),
