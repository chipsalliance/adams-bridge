...
// | Created on 19.03.2025 at 12:23                    |
// | Contact: contact@lubis-eda.com                    |
// | Author: Tobias Ludwig, Michael Schwarz            |
// +---------------------------------------------------+


import fv_ntt_ctrl_ct_mode_pkg::*;
...
function logic unsigned [6:0] twiddle_rand_offset(logic unsigned [2:0] count, logic unsigned [1:0] ptr, logic unsigned [3:0] chunk);
  if ((count == 3'd0))
    ...
    return 7'(((64'd4 * ({ 62'h0, chunk[1:0]} )) + ptr));
  else if ((count == 3'd3))
    return 7'(((64'd4 * chunk) + ptr));
  else
    return 7'd0;
endfunction


module fv_ntt_ctrl_ct_mode_m(
  input logic rst,
  input logic clk,
...
assign read_req_0_i = '{
  request: (shuffle_en_in ? ((({ 17'd0, read_req.address} ) <= (63 + ((rounds_count_in == 3'd0) ? ({ 18'd0, base_address_port.source} ) : ((rounds_count_in[0] == 0) ? ({ 18'd0, base_address_port.destination} ) : ({ 18'd0, base_address_port.interim} ))))) && !((buf_count == 2'd3) && (rd_valid_count == 7'd60))) : (({ 17'd0, read_req.address} ) <= (63 + ((rounds_count_in == 3'd0) ? ({ 18'd0, base_address_port.source} ) : ((rounds_count_in[0] == 0) ? ({ 18'd0, base_address_port.destination} ) : ({ 18'd0, base_address_port.interim} )))))),
...
assign mem_write_req_port_0_i = '{
  request: 0,
  address: (shuffle_en ? 15'((({ 50'd0, base_address_port.interim} ) + (64'd4 * ({ 60'd0, chunk_rand_offset} )))) : 15'(base_address_port.interim))
};

st_Request_and_Address mem_write_req_port_1_i;
assign mem_write_req_port_1_i = '{
  request: 0,
  address: (shuffle_en ? 15'((((rounds_count[0] == 0) ? ({ 50'd0, base_address_port.interim} ) : ({ 50'd0, base_address_port.destination} )) + (64'd4 * ({ 60'd0, chunk_rand_offset} )))) : 15'(((rounds_count[0] == 0) ? base_address_port.interim : base_address_port.destination)))
};

st_Request_and_Address mem_write_req_port_2_i;
assign mem_write_req_port_2_i = '{
  request: butterfly_ready_in,
  address: (butterfly_ready_in ? 15'((((shuffle_en ? 16'((((64'd4 * chunk_count_reg_port) + buf_rdptr_reg_port) + ((rounds_count[0] == 0) ? ({ 50'd0, base_address_port.interim} ) : ({ 50'd0, base_address_port.destination} )))) : 16'((1 + ({ 17'd0, write_req.address} )))) > (64'd63 + ((rounds_count[0] == 0) ? ({ 50'd0, base_address_port.interim} ) : ({ 50'd0, base_address_port.destination} )))) ? ((shuffle_en ? 16'((((64'd4 * chunk_count_reg_port) + buf_rdptr_reg_port) + ((rounds_count[0] == 0) ? ({ 50'd0, base_address_port.interim} ) : ({ 50'd0, base_address_port.destination} )))) : 16'((1 + ({ 17'd0, write_req.address} )))) - 15'd63) : 16'((shuffle_en ? { 16'((((64'd4 * chunk_count_reg_port) + buf_rdptr_reg_port) + ((rounds_count[0] == 0) ? ({ 50'd0, base_address_port.interim} ) : ({ 50'd0, base_address_port.destination} )))) }[14:0] : { 16'((1 + ({ 17'd0, write_req.address} ))) }[14:0])))) : write_req.address)
};
...
endproperty
read_read_buf_to_read_buf_a: assert property (disable iff(rst) read_read_buf_to_read_buf_p);
...
endproperty
read_read_buf_to_read_exec_a: assert property (disable iff(rst) read_read_buf_to_read_exec_p);
...
|->
  ...
  rd_valid_count == (((($past(read_state, 1) == CtReadIdle) || ($past(read_state, 1) == CtReadStage)) || ($past(buf0_valid_in, 1) && ($past(rd_valid_count, 1) > 7'd64))) ? 7'd0 : $past(rd_valid_count, 1));
endproperty
read_read_exec_to_read_buf_a: assert property (disable iff(rst) read_read_exec_to_read_buf_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'(($past(shuffle_en_in, 1) ? ({ 57'd0, $past(twiddle_rand_offset_0_i, 1)} ) : (($past(twiddle_addr_reg, 1) == $past(twiddle_end_addr_0_i, 1)) ? 64'd0 : 7'((64'd1 + ({ 57'd0, $past(twiddle_addr_reg, 1)} ))))));
endproperty
read_read_exec_to_read_exec_a: assert property (disable iff(rst) read_read_exec_to_read_exec_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'(($past(shuffle_en_in, 1) ? ({ 57'd0, $past(twiddle_rand_offset_0_i, 1)} ) : (($past(twiddle_addr_reg, 1) == $past(twiddle_end_addr_0_i, 1)) ? 64'd0 : 7'((64'd1 + ({ 57'd0, $past(twiddle_addr_reg, 1)} ))))));
endproperty
read_read_exec_to_read_exec_wait_a: assert property (disable iff(rst) read_read_exec_to_read_exec_wait_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'(($past(shuffle_en_in, 1) ? ({ 57'd0, $past(twiddle_rand_offset_0_i, 1)} ) : (($past(twiddle_addr_reg, 1) == $past(twiddle_end_addr_0_i, 1)) ? 64'd0 : 7'((64'd1 + ({ 57'd0, $past(twiddle_addr_reg, 1)} ))))));
endproperty
read_read_exec_wait_to_read_exec_wait_a: assert property (disable iff(rst) read_read_exec_wait_to_read_exec_wait_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'(($past(shuffle_en_in, 1) ? ({ 57'd0, $past(twiddle_rand_offset_0_i, 1)} ) : (($past(twiddle_addr_reg, 1) == $past(twiddle_end_addr_0_i, 1)) ? 64'd0 : 7'((64'd1 + ({ 57'd0, $past(twiddle_addr_reg, 1)} ))))));
endproperty
read_read_exec_wait_to_read_stage_a: assert property (disable iff(rst) read_read_exec_wait_to_read_stage_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'd0;
endproperty
read_read_idle_to_read_idle_a: assert property (disable iff(rst) read_read_idle_to_read_idle_p);
...
|->
  ...
  twiddle_addr_reg_out == 7'd0;
endproperty
read_read_idle_to_read_stage_a: assert property (disable iff(rst) read_read_idle_to_read_stage_p);
...
endproperty
read_read_stage_to_read_buf_a: assert property (disable iff(rst) read_read_stage_to_read_buf_p);
...
|->
  ...
  twiddle_addr_reg_out == ($past(butterfly_ready_in, 1) ? $past(twiddle_addr_reg, 1) : 7'd0);
endproperty
read_read_stage_to_read_idle_a: assert property (disable iff(rst) read_read_stage_to_read_idle_p);
...
|->
  ...
  twiddle_addr_reg_out == ($past(butterfly_ready_in, 1) ? $past(twiddle_addr_reg, 1) : 7'd0);
endproperty
read_read_stage_to_read_stage_a: assert property (disable iff(rst) read_read_stage_to_read_stage_p);
...
|->
  ##1
  write_idle &&
  chunk_count == (($past(buf_count, 1) == 2'd3) ? 4'((64'd1 + ({ 60'h0, $past(chunk_count, 1)} ))) : ({ 60'h0, $past(chunk_count, 1)} )) &&
...
endproperty
write_write_idle_to_write_idle_a: assert property (disable iff(rst) write_write_idle_to_write_idle_p);
...
|->
  ...
  wr_valid_count == (($past(write_state, 1) == CtWriteMem) ? ($past(butterfly_ready_in, 1) ? (7'd1 + $past(wr_valid_count, 1)) : $past(wr_valid_count, 1)) : 7'd0);
endproperty
write_write_idle_to_write_stage_a: assert property (disable iff(rst) write_write_idle_to_write_stage_p);
...
|->
  ...
  wr_valid_count == (($past(write_state, 1) == CtWriteMem) ? ($past(butterfly_ready_in, 1) ? (7'd1 + $past(wr_valid_count, 1)) : $past(wr_valid_count, 1)) : 7'd0);
endproperty
write_write_mem_to_write_mem_a: assert property (disable iff(rst) write_write_mem_to_write_mem_p);
...
|->
  ...
  chunk_rand_offset == { $past(random_in, 1) }[5:2] &&
  mem_write_req_port == $past(mem_write_req_port_2_i, 1) &&
  rounds_count_out == (($past(rounds_count, 1) < 3'd4) ? (3'd1 + $past(rounds_count, 1)) : 3'd0) &&
  wr_valid_count == (($past(write_state, 1) == CtWriteMem) ? ($past(butterfly_ready_in, 1) ? (7'd1 + $past(wr_valid_count, 1)) : $past(wr_valid_count, 1)) : 7'd0);
endproperty
write_write_mem_to_write_stage_a: assert property (disable iff(rst) write_write_mem_to_write_stage_p);
...
|->
  ...
  wr_valid_count == (($past(write_state, 1) == CtWriteMem) ? ($past(butterfly_ready_in, 1) ? (7'd1 + $past(wr_valid_count, 1)) : $past(wr_valid_count, 1)) : 7'd0);
endproperty
write_write_stage_to_write_idle_a: assert property (disable iff(rst) write_write_stage_to_write_idle_p);
...
|->
  ...
  wr_valid_count == (($past(write_state, 1) == CtWriteMem) ? ($past(butterfly_ready_in, 1) ? (7'd1 + $past(wr_valid_count, 1)) : $past(wr_valid_count, 1)) : 7'd0);
endproperty
write_write_stage_to_write_mem_a: assert property (disable iff(rst) write_write_stage_to_write_mem_p);
...
endproperty
read_read_idle_eventually_left_a: assert property (disable iff(rst) read_read_idle_eventually_left_p);
...
endproperty
read_read_stage_eventually_left_a: assert property (disable iff(rst) read_read_stage_eventually_left_p);
...
endproperty
read_read_buf_eventually_left_a: assert property (disable iff(rst) read_read_buf_eventually_left_p);
...
endproperty
read_read_exec_eventually_left_a: assert property (disable iff(rst) read_read_exec_eventually_left_p);
...
endproperty
read_read_exec_wait_eventually_left_a: assert property (disable iff(rst) read_read_exec_wait_eventually_left_p);
...
endproperty
write_write_idle_eventually_left_a: assert property (disable iff(rst) write_write_idle_eventually_left_p);
...
endproperty
write_write_stage_eventually_left_a: assert property (disable iff(rst) write_write_stage_eventually_left_p);
...
endproperty
write_write_mem_eventually_left_a: assert property (disable iff(rst) write_write_mem_eventually_left_p);
