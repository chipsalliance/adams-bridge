...
module fv_ntt_ctrl_gs_mode_ref_wrapper_m;
...
function logic unsigned [14:0] mem_rd_addr_base();
  if (!$past(ntt_ctrl.reset_n)) begin
...
fv_ntt_ctrl_gs_mode_m fv_ntt_ctrl_gs_mode(
...
bind ntt_ctrl fv_ntt_ctrl_gs_mode_ref_wrapper_m fv_ntt_ctrl_gs_mode_ref_wrapper();
