...
module fv_ntt_ctrl_pwo_constraints
...
(
  ...
  property wip_ntt_mode;
    (pi_ntt_mode == pwm || pi_ntt_mode == pwa || pi_ntt_mode == pws) ;
  endproperty
...
bind ntt_ctrl fv_ntt_ctrl_pwo_constraints fv_ntt_ctrl_pwo_constraints_i(
    .pi_clk (clk),
    .pi_reset_n (reset_n),
    .pi_zeroize (zeroize),
