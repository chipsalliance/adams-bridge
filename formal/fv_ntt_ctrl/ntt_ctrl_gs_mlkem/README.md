...
## Folder Structure
The following files are part of the main directory **<project_root>/formal/fv_ntt_ctrl/ntt_ctrl_gs_mlkem**

- **model/ntt_ctrl_gs_mlkem.h** is the ESL model of ntt_ctrl block in gs masking mode written in SystemC

- **model/ntt_ctrl_gs_mlkem.luref** is the refinement file of the esl model to the rtl design, used to generate the binding file.

- **ntt_ctrl_gs_mlkem.sv** contains the auto-generated assertion IP(AIP) by LUBIS AppBuilder for ntt_ctrl block in gs mode

- **ntt_ctrl_gs_mlkem_functions.sv** contains the auto-generated functions by LUBIS AppBuilder which are used in the AIP

- **ntt_ctrl_gs_mlkem_binding.sv** contains the auto-generated binding file by LUBIS AppBuilder which links the AIP to the DUT

- **ntt_ctrl_gs_mlkem_pkg.sv** contains the auto-generated package/enum declaration by LUBIS AppBuilder used in the AIP

- **fv_ntt_ctrl_gs_mlkem_additional_aips.sv** contains the additional assertions for ntt_ctrl block in gs mode

- **fv_ntt_ctrl_gs_mlkem_constraints.sv** contains the assumptions/constraints for ntt_ctrl_gs_mlkem mode

- **fv_ntt_ctrl_gs_mlkem_top.sv** is the wrapper file.
...
- assert_different_rd_wr_addrs_p: Checks whenever mem_rd_en && mem_wr_en -> mem_rd_addr != mem_wr_addr

- assert_twiddle_addr_a: Checks twiddle_addr output during gs mode.

- assert_mem_rd_en_a: Checks mem_rd_en output during gs mode.

- assert_mem_wr_en_a: Checks mem_wr_en output during gs mode.

- assert_buf_wren_a: Checks buf_wren output during gs mode

- assert_buf_wren_intt_reg_a: Checks buf_wren_intt_reg register during gs mode

- assert_buf_rden_a: Checks buf_rden output during gs mode

- assert_buf_wr_rst_count_a: Checks buf_wr_rst_count during gs mode

- assert_buf_rd_rst_count_a: Checks buf_rd_rst_count during gs mode

- assert_busy_a: Checks busy signal output during gs mode.

- assert_rst_rounds_a: Checks rst_rounds register during gs mode.
