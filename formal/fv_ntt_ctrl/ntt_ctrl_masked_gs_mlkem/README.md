# ntt_ctrl_masked_gs_mlkem
Date: 02.09.2025
Author: LUBIS EDA

## Folder Structure
The following files are part of the main directory **<project_root>/formal/fv_ntt_ctrl/ntt_ctrl_masked_gs_mlkem**

- **model/ntt_ctrl_masked_gs_mlkem.h** is the ESL model of ntt_ctrl block in gs masking mode written in SystemC

- **model/ntt_ctrl_masked_gs_mlkem.luref** is the refinement file of the esl model to the rtl design, used to generate the binding file.

- **ntt_ctrl_masked_gs_mlkem.sv** contains the auto-generated assertion IP(AIP) by LUBIS AppBuilder for ntt_ctrl block in masked gs mode

- **ntt_ctrl_masked_gs_mlkem_functions.sv** contains the auto-generated functions by LUBIS AppBuilder which are used in the AIP

- **ntt_ctrl_masked_gs_mlkem_binding.sv** contains the auto-generated binding file by LUBIS AppBuilder which links the AIP to the DUT

- **ntt_ctrl_masked_gs_mlkem_pkg.sv** contains the auto-generated package/enum declaration by LUBIS AppBuilder used in the AIP

- **fv_ntt_ctrl_masked_gs_mlkem_additional_aips.sv** contains the additional assertions for ntt_ctrl block in masked gs mode

- **fv_ntt_ctrl_masked_gs_mlkem_constraints.sv** contains the assumptions/constraints for ntt_ctrl_masked_gs_mlkem mode

- **fv_ntt_ctrl_masked_gs_mlkem_top.sv** is the wrapper file.
...
- commons_state_to_state_a: Checks for common output such as opcode, and also checks for non gs outputs should be zero

- read_read_exec_to_read_exec_a: Checks for all gs-related outputs & regs during read_exec to read_exec state transition.

- read_read_exec_to_read_stage_a: Checks for all gs-related outputs & regs during read_exec to read_stage state transition.

- read_read_idle_to_read_idle_a: Checks for all gs-related outputs & regs during read_idle to read_idle state transition.

- read_read_idle_to_read_stage_a: Checks for all gs-related outputs & regs during read_idle to read_stage state transition.

- read_read_stage_to_read_exec_a: Checks for all gs-related outputs & regs during read_stage to read_exec state transition.

- read_read_stage_to_read_idle_a: Checks for all gs-related outputs & regs during read_stage to read_idle state transition.

- read_read_stage_to_read_stage_a: Checks for all gs-related outputs & regs during read_stage to read_stage state transition.

- write_write_buf_to_write_buf_a: Checks for all gs-related outputs & regs during write_buf to write_buf state transition.

- write_write_buf_to_write_mem_a: Checks for all gs-related outputs & regs during write_buf to write_mem state transition.

- write_write_idle_to_write_idle_a: Checks for all gs-related outputs & regs during write_idle to write_idle state transition.

- write_write_idle_to_write_stage_a: Checks for all gs-related outputs & regs during write_idle to write_stage state transition.

- write_write_mem_to_write_buf_a: Checks for all gs-related outputs & regs during write_mem to write_buf state transition.

- write_write_mem_to_write_mem_a: Checks for all gs-related outputs & regs during write_mem to write_mem state transition.

- write_write_mem_to_write_wait_a: Checks for all gs-related outputs & regs during write_mem to write_wait state transition.

- write_write_stage_to_write_buf_a: Checks for all gs-related outputs & regs during write_stage to write_idle state transition.

- write_write_stage_to_write_idle_a: Checks for all gs-related outputs & regs during write_stage to write_idle state transition.

- write_write_wait_to_write_stage_a: Checks for all gs-related outputs & regs during write_wait to write_stage state transition.

- write_write_wait_to_write_wait_a: Checks for all gs-related outputs & regs during write_wait to write_wait state transition.
...
- write_write_buf_eventually_left_a: Liveness assertion to check that state write_buf is eventually left.
...
- assert_twiddle_addr_a: Checks twiddle_addr output during masked gs mode.

- assert_mem_rd_en_a: Checks mem_rd_en output during masked gs mode.

- assert_mem_wr_en_a: Checks mem_wr_en output during masked gs mode.

- assert_buf_wren_a: Checks buf_wren output during masked gs mode

- assert_buf_rden_a: Checks buf_rden output during masked gs mode

- assert_buf_wr_rst_count_a: Checks buf_wr_rst_count during masked gs mode

- assert_buf_rd_rst_count_a: Checks buf_rd_rst_count during masked gs mode

- assert_busy_a: Checks busy signal output during masked gs mode.

- assert_rst_rounds_a: Checks rst_rounds register during masked gs mode.
