...
## Folder Structure
The following files are part of the main directory **<project_root>/formal/fv_ntt_ctrl/ntt_ctrl_ct_mlkem**

- **model/ntt_ctrl_ct_mlkem.h** is the ESL model of ntt_ctrl block in ct masking mode written in SystemC

- **model/ntt_ctrl_ct_mlkem.luref** is the refinement file of the esl model to the rtl design, used to generate the binding file.

- **ntt_ctrl_ct_mlkem.sv** contains the auto-generated assertion IP(AIP) by LUBIS AppBuilder for ntt_ctrl block in ct mode

- **ntt_ctrl_ct_mlkem_functions.sv** contains the auto-generated functions by LUBIS AppBuilder which are used in the AIP

- **ntt_ctrl_ct_mlkem_binding.sv** contains the auto-generated binding file by LUBIS AppBuilder which links the AIP to the DUT

- **ntt_ctrl_ct_mlkem_pkg.sv** contains the auto-generated package/enum declaration by LUBIS AppBuilder used in the AIP

- **fv_ntt_ctrl_ct_mlkem_additional_aips.sv** contains the additional assertions for ntt_ctrl block in ct mode

- **fv_ntt_ctrl_ct_mlkem_constraints.sv** contains the assumptions/constraints for ntt_ctrl_ct_mlkem mode

- **fv_ntt_ctrl_ct_mlkem_top.sv** is the wrapper file.
...
- read_read_buf_to_read_buf_a: Checks for all ct-related outputs & regs during read_buf to read_buf state transition.

- read_read_buf_to_read_exec_a: Checks for all ct-related outputs & regs during read_buf to read_exec state transition.

- read_read_exec_to_read_buf_a: Checks for all ct-related outputs & regs during read_exec to read_buf state transition.

- read_read_exec_to_read_exec_a: Checks for all ct-related outputs & regs during read_exec to read_exec state transition.

- read_read_exec_to_read_exec_wait_a: Checks for all ct-related outputs & regs during read_exec to read_exec_wait state transition.

- read_read_exec_wait_to_read_exec_wait_a: Checks for all ct-related outputs & regs during read_exec_wait to read_exec_wait state transition.

- read_read_exec_wait_to_read_stage_a: Checks for all ct-related outputs & regs during read_exec_wait to read_stage state transition.

- read_read_idle_to_read_idle_a: Checks for all ct-related outputs & regs during read_idle to read_idle state transition.

- read_read_idle_to_read_stage_a: Checks for all ct-related outputs & regs during read_idle to read_stage state transition.

- read_read_stage_to_read_buf_a: Checks for all ct-related outputs & regs during read_stage to read_buf state transition.

- read_read_stage_to_read_idle_a: Checks for all ct-related outputs & regs during read_stage to read_idle state transition.

- read_read_stage_to_read_stage_a: Checks for all ct-related outputs & regs during read_stage to read_stage state transition.

- write_write_idle_to_write_idle_a: Checks for all ct-related outputs & regs during write_idle to write_idle state transition.

- write_write_idle_to_write_stage_a: Checks for all ct-related outputs & regs during write_idle to write_stage state transition.

- write_write_mem_to_write_mem_a: Checks for all ct-related outputs & regs during write_mem to write_mem state transition.

- write_write_mem_to_write_stage_a: Checks for all ct-related outputs & regs during write_mem to write_wait state transition.

- write_write_stage_to_write_mem_a: Checks for all ct-related outputs & regs during write_stage to write_mem state transition.

- write_write_stage_to_write_idle_a: Checks for all ct-related outputs & regs during write_stage to write_idle state transition.
...
- read_read_buf_eventually_left_a: Liveness assertion to check that state read_buf is eventually left.
...
- assert_not_same_address_a: Checks whenever mem_rd_en && mem_wr_en -> mem_rd_addr != mem_wr_addr

- assert_bf_enable_a: Checks the bf_enable output during masked gs mode.

- assert_twiddle_addr_a: Checks twiddle_addr output during ct mode.

- assert_mem_rd_en_a: Checks mem_rd_en output during ct mode.

- assert_mem_rd_en_exec_a: Checks mem_rd_en during read_exec or read_buf state in ct mode

- assert_mem_wr_en_a: Checks mem_wr_en output during ct mode.

- assert_buf_wren_a: Checks buf_wren output during ct mode

- assert_buf_wren_intt_reg_a: Checks buf_wren_intt_reg register during ct mode

- assert_buf_rd_en_a: Checks buf_rd_en output during ct mode

- assert_buf_wr_rst_count_a: Checks buf_wr_rst_count during ct mode

- assert_buf_rd_rst_count_a: Checks buf_rd_rst_count during ct mode

- assert_buf_rdptr_a: check buf_rdptr output during ct mode

- assert_buf_wr_ptr_check_p: Checks buf_wrptr output during ct mode

- assert_busy_a: Checks busy signal output during ct mode.

- assert_rst_rounds_a: Checks rst_rounds register during ct mode.

- assert_latch_index_rand_offset_a: Checks latch_index_rand_offset register during ct mode

- assert_latch_chunk_rand_offset_a: Checks latch_chunk_rand_offset register during ct mode
