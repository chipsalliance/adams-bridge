...
module fv_decompose_sign_mode_ref_wrapper_m;


a_unsigned_23_4 rd_data_port;
assign rd_data_port = '{decompose.mem_rd_data[95:72], decompose.mem_rd_data[71:48], decompose.mem_rd_data[47:24], decompose.mem_rd_data[23:0]};

a_unsigned_16_4 w1_encode_r1_i_in;
assign w1_encode_r1_i_in = '{decompose.w1_enc_inst.r1_i, decompose.w1_o[63:48], decompose.w1_o[47:32], decompose.w1_o[31:16]};

a_unsigned_1_4 z_d1_in;
assign z_d1_in = '{decompose.z_neq_z_d1[3], decompose.z_neq_z_d1[2], decompose.z_neq_z_d1[1], decompose.z_neq_z_d1[0]};

a_unsigned_1_4 z_d2_in;
assign z_d2_in = '{decompose.z_neq_z_d2[3], decompose.z_neq_z_d2[2], decompose.z_neq_z_d2[1], decompose.z_neq_z_d2[0]};

a_unsigned_24_4 mem_wr_data;
assign mem_wr_data = '{decompose.mem_wr_data[95:72], decompose.mem_wr_data[71:48], decompose.mem_wr_data[47:24], decompose.mem_wr_data[23:0]};

a_unsigned_1_4 z_neq_z;
assign z_neq_z = '{decompose.z_neq_z[3], decompose.z_neq_z[2], decompose.z_neq_z[1], decompose.z_neq_z[0]};

a_unsigned_1_4 z_neq_z_d1;
assign z_neq_z_d1 = '{decompose.z_neq_z_d1[3], decompose.z_neq_z_d1[2], decompose.z_neq_z_d1[1], decompose.z_neq_z_d1[0]};

a_unsigned_1_4 z_neq_z_d2;
assign z_neq_z_d2 = '{decompose.z_neq_z_d2[3], decompose.z_neq_z_d2[2], decompose.z_neq_z_d2[1], decompose.z_neq_z_d2[0]};


fv_decompose_sign_mode_m fv_decompose_sign_mode(
  ...
  .w1_encode_r1_i_in(w1_encode_r1_i_in),
  ...
  .r0_reg(decompose.r0_reg),

  .w1_encode_r1_i(decompose.w1_enc_inst.r1_i),
  ...
  .z_neq_z_d1(z_neq_z_d1),

  .z_neq_z_d2(z_neq_z_d2),

  // Registers
  .base_address({decompose.src_base_addr, decompose.dest_base_addr, decompose.hint_src_base_addr}),

  // States
  .IDLE(decompose.dcmp_ctrl_inst.read_fsm_state_ps == DCMP_RD_IDLE && decompose.dcmp_ctrl_inst.write_fsm_state_ps == DCMP_WR_IDLE),
...
bind decompose fv_decompose_sign_mode_ref_wrapper_m fv_decompose_sign_mode_ref_wrapper();
