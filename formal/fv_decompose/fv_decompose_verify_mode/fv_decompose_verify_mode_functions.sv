...
package decompose_verify_mode_functions;
...
function logic unsigned [3:0][3:0] compute_r1(logic unsigned [3:0][22:0] data);
  logic unsigned [3:0][3:0] result; // @ decompose_verify_mode.h:86:3
  logic signed [31:0] i;            // @ decompose_verify_mode.h:88:7
...
function logic unsigned [3:0][0:0] compute_z(logic unsigned [3:0][22:0] data);
  logic unsigned [3:0][0:0] result; // @ decompose_verify_mode.h:95:3
  logic signed [31:0] i;            // @ decompose_verify_mode.h:97:7
...
function logic unsigned [22:0] compute_r0_mod_2GAMMA2(logic unsigned [22:0] data);
  logic unsigned [22:0] result; // @ decompose_verify_mode.h:109:3

  result = 23'd0;

  if ((data % unsigned'(19'(32'd2 * 32'd261888))) <= 18'd261888) begin
    result = 23'(data % unsigned'(32'd2 * 32'd261888));
  end else begin
    result = 23'((data % unsigned'(32'd2 * 32'd261888)) + 64'd7856641);
  end
...
function logic unsigned [3:0][22:0] compute_r0(logic unsigned [3:0][22:0] data);
  logic unsigned [3:0][22:0] result; // @ decompose_verify_mode.h:121:3
  logic signed [31:0] i;             // @ decompose_verify_mode.h:123:7
  ...
  for (i = 32'd0; i < 32'd4; i = i + 32'd1) begin
    if (data[unsigned'(i)] > unsigned'(23'(32'd31 * 32'd261888))) begin
      ...
      result[unsigned'(i)] = compute_r0_mod_2GAMMA2(data[unsigned'(i)]);
    end
  end
...
function logic unsigned [3:0][22:0] compute_r0_1(logic unsigned [3:0][22:0] data);
  logic unsigned [3:0][22:0] result; // @ decompose_verify_mode.h:136:3
  logic signed [31:0] i;             // @ decompose_verify_mode.h:138:7
...
function logic unsigned [3:0][22:0] compute_r0_2(logic unsigned [3:0][22:0] data, logic unsigned [3:0] valid, logic unsigned [3:0][22:0] data2);
  logic unsigned [3:0][22:0] result; // @ decompose_verify_mode.h:159:3
  logic signed [31:0] i;             // @ decompose_verify_mode.h:161:7
...
function logic unsigned [3:0][22:0] compute_r0_3(logic unsigned [3:0][22:0] data, logic valid, logic unsigned [3:0][22:0] data2);
  logic unsigned [3:0][22:0] result; // @ decompose_verify_mode.h:178:3
  logic signed [31:0] i;             // @ decompose_verify_mode.h:180:7
...
function logic is_buffer_usehint(logic unsigned [13:0] data);
  if ((data % 64'd4) == 64'd0) begin
    return 1;
  end else begin
    return 0;
  end
...
function logic unsigned [3:0] compute_r1_mux(logic unsigned [22:0] data1, logic unsigned [3:0] data2);
  logic unsigned [3:0] result; // @ decompose_verify_mode.h:206:5

  result = 4'd0;

  if ((data1 == 23'd0) || (data1 > 23'd261888)) begin
    result = (data2 - 64'd1) % 64'd16;
  end else begin
    result = (data2 + 64'd1) % 64'd16;
  end
...
function logic unsigned [3:0][3:0] compute_r1_usehint(logic unsigned [3:0][3:0] data, logic unsigned [3:0][22:0] data1, logic unsigned [3:0][0:0] hint);
  logic unsigned [3:0][3:0] result; // @ decompose_verify_mode.h:218:5
  logic signed [31:0] i;            // @ decompose_verify_mode.h:220:9

  result = '{ 0: 4'd0, 1: 4'd0, 2: 4'd0, 3: 4'd0 };

  for (i = 32'd0; i < 32'd4; i = i + 32'd1) begin
    if (hint[unsigned'(i)] == 64'd0) begin
      result[unsigned'(i)] = data[unsigned'(i)];
    end else begin
      result[unsigned'(i)] = compute_r1_mux(data1[unsigned'(i)], data[unsigned'(i)]);
    end
  end
