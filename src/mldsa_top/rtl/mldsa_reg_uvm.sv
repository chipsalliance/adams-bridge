...
package mldsa_reg_uvm;
    ...
    class mldsa_reg__MLDSA_CTRL extends uvm_reg;
        ...
        mldsa_reg__MLDSA_CTRL_bit_cg NEXT_MSG_bit_cg[1];
        ...
        virtual function void build();
            ...
            this.NEXT_MSG = new("NEXT_MSG");
            this.NEXT_MSG.configure(this, 1, 6, "WO", 1, 'h0, 1, 1, 0);
            if (has_coverage(UVM_CVR_REG_BITS)) begin
                ...
                foreach(NEXT_MSG_bit_cg[bt]) NEXT_MSG_bit_cg[bt] = new();
            end
            if (has_coverage(UVM_CVR_FIELD_VALS))
                fld_cg = new();
        endfunction : build
    ...
    class mldsa_reg__MLDSA_STATUS extends uvm_reg;
        ...
        virtual function void build();
            ...
            this.MSG_DONE = new("MSG_DONE");
            this.MSG_DONE.configure(this, 1, 2, "RO", 1, 'h0, 1, 1, 0);
            if (has_coverage(UVM_CVR_REG_BITS)) begin
                foreach(READY_bit_cg[bt]) READY_bit_cg[bt] = new();
                foreach(VALID_bit_cg[bt]) VALID_bit_cg[bt] = new();
                foreach(MSG_DONE_bit_cg[bt]) MSG_DONE_bit_cg[bt] = new();
            end
            if (has_coverage(UVM_CVR_FIELD_VALS))
                fld_cg = new();
        endfunction : build
    ...
    class mldsa_reg extends uvm_reg_block;
        ...
        rand mldsa_reg__MLDSA_MSG MLDSA_MSG[34];
        ...
        virtual function void build();
            ...
            foreach(this.MLDSA_CTX[i0]) begin
                ...
                this.default_map.add_reg(this.MLDSA_CTX[i0], 'h12c + i0*'h4);
            end
            foreach(this.MLDSA_VERIFY_RES[i0]) begin
                ...
                this.default_map.add_reg(this.MLDSA_VERIFY_RES[i0], 'h22c + i0*'h4);
            end
            foreach(this.MLDSA_EXTERNAL_MU[i0]) begin
                ...
                this.default_map.add_reg(this.MLDSA_EXTERNAL_MU[i0], 'h26c + i0*'h4);
            end
