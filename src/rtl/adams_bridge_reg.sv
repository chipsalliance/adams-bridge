...
module adams_bridge_reg (
        ...
        input adams_bridge_reg_pkg::adams_bridge_reg__in_t hwif_in,
        output adams_bridge_reg_pkg::adams_bridge_reg__out_t hwif_out
    );
    ...
    typedef struct packed{
        logic [2-1:0]ADAMS_BRIDGE_NAME;
        logic [2-1:0]ADAMS_BRIDGE_VERSION;
        logic ADAMS_BRIDGE_CTRL;
        logic ADAMS_BRIDGE_STATUS;
        logic [16-1:0]ADAMS_BRIDGE_IV;
        logic [8-1:0]ADAMS_BRIDGE_SEED;
        logic [8-1:0]ADAMS_BRIDGE_SIGN_RND;
        logic [16-1:0]ADAMS_BRIDGE_MSG;
        logic [16-1:0]ADAMS_BRIDGE_VERIFY_RES;
        logic [1216-1:0]ADAMS_BRIDGE_PRIVKEY_OUT;
        logic [1216-1:0]ADAMS_BRIDGE_PRIVKEY_IN;
        logic [648-1:0]ADAMS_BRIDGE_PUBKEY;
        logic [1149-1:0]ADAMS_BRIDGE_SIGNATURE;
        struct packed{
    ...
    always_comb begin
        for(int i0=0; i0<2; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_NAME[i0] = cpuif_req_masked & (cpuif_addr == 15'h0 + i0*15'h4);
        end
        for(int i0=0; i0<2; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_VERSION[i0] = cpuif_req_masked & (cpuif_addr == 15'h8 + i0*15'h4);
        end
        decoded_reg_strb.ADAMS_BRIDGE_CTRL = cpuif_req_masked & (cpuif_addr == 15'h10);
        decoded_reg_strb.ADAMS_BRIDGE_STATUS = cpuif_req_masked & (cpuif_addr == 15'h18);
        for(int i0=0; i0<16; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_IV[i0] = cpuif_req_masked & (cpuif_addr == 15'h80 + i0*15'h4);
        end
        for(int i0=0; i0<8; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_SEED[i0] = cpuif_req_masked & (cpuif_addr == 15'h100 + i0*15'h4);
        end
        for(int i0=0; i0<8; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_SIGN_RND[i0] = cpuif_req_masked & (cpuif_addr == 15'h180 + i0*15'h4);
        end
        for(int i0=0; i0<16; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_MSG[i0] = cpuif_req_masked & (cpuif_addr == 15'h200 + i0*15'h4);
        end
        for(int i0=0; i0<16; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_VERIFY_RES[i0] = cpuif_req_masked & (cpuif_addr == 15'h280 + i0*15'h4);
        end
        for(int i0=0; i0<1216; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_PRIVKEY_OUT[i0] = cpuif_req_masked & (cpuif_addr == 15'h300 + i0*15'h4);
        end
        for(int i0=0; i0<1216; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_PRIVKEY_IN[i0] = cpuif_req_masked & (cpuif_addr == 15'h1600 + i0*15'h4);
        end
        for(int i0=0; i0<648; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_PUBKEY[i0] = cpuif_req_masked & (cpuif_addr == 15'h2900 + i0*15'h4);
        end
        for(int i0=0; i0<1149; i0++) begin
            decoded_reg_strb.ADAMS_BRIDGE_SIGNATURE[i0] = cpuif_req_masked & (cpuif_addr == 15'h3400 + i0*15'h4);
        end
        decoded_reg_strb.intr_block_rf.global_intr_en_r = cpuif_req_masked & (cpuif_addr == 15'h4600);
        decoded_reg_strb.intr_block_rf.error_intr_en_r = cpuif_req_masked & (cpuif_addr == 15'h4604);
        decoded_reg_strb.intr_block_rf.notif_intr_en_r = cpuif_req_masked & (cpuif_addr == 15'h4608);
        decoded_reg_strb.intr_block_rf.error_global_intr_r = cpuif_req_masked & (cpuif_addr == 15'h460c);
        decoded_reg_strb.intr_block_rf.notif_global_intr_r = cpuif_req_masked & (cpuif_addr == 15'h4610);
        decoded_reg_strb.intr_block_rf.error_internal_intr_r = cpuif_req_masked & (cpuif_addr == 15'h4614);
        decoded_reg_strb.intr_block_rf.notif_internal_intr_r = cpuif_req_masked & (cpuif_addr == 15'h4618);
        decoded_reg_strb.intr_block_rf.error_intr_trig_r = cpuif_req_masked & (cpuif_addr == 15'h461c);
        decoded_reg_strb.intr_block_rf.notif_intr_trig_r = cpuif_req_masked & (cpuif_addr == 15'h4620);
        decoded_reg_strb.intr_block_rf.error_internal_intr_count_r = cpuif_req_masked & (cpuif_addr == 15'h4700);
        decoded_reg_strb.intr_block_rf.notif_cmd_done_intr_count_r = cpuif_req_masked & (cpuif_addr == 15'h4780);
        decoded_reg_strb.intr_block_rf.error_internal_intr_count_incr_r = cpuif_req_masked & (cpuif_addr == 15'h4800);
        decoded_reg_strb.intr_block_rf.notif_cmd_done_intr_count_incr_r = cpuif_req_masked & (cpuif_addr == 15'h4804);
    end
    ...
    typedef struct packed{
        ...
        } [16-1:0]ADAMS_BRIDGE_IV;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } SEED;
        } [8-1:0]ADAMS_BRIDGE_SEED;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } SIGN_RND;
        } [8-1:0]ADAMS_BRIDGE_SIGN_RND;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } MSG;
        } [16-1:0]ADAMS_BRIDGE_MSG;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } VERIFY_RES;
        } [16-1:0]ADAMS_BRIDGE_VERIFY_RES;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } PRIVKEY_OUT;
        } [1216-1:0]ADAMS_BRIDGE_PRIVKEY_OUT;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } PRIVKEY_IN;
        } [1216-1:0]ADAMS_BRIDGE_PRIVKEY_IN;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } PUBKEY;
        } [648-1:0]ADAMS_BRIDGE_PUBKEY;
        struct packed{
            struct packed{
                logic [31:0] next;
                logic load_next;
            } SIGNATURE;
        } [1149-1:0]ADAMS_BRIDGE_SIGNATURE;
        struct packed{
            struct packed{
                struct packed{
                    logic next;
    ...
    // Field: adams_bridge_reg.ADAMS_BRIDGE_CTRL.CTRL
    always_comb begin
        automatic logic [1:0] next_c = field_storage.ADAMS_BRIDGE_CTRL.CTRL.value;
        automatic logic load_next_c = '0;
        if(decoded_reg_strb.ADAMS_BRIDGE_CTRL && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
            next_c = (field_storage.ADAMS_BRIDGE_CTRL.CTRL.value & ~decoded_wr_biten[1:0]) | (decoded_wr_data[1:0] & decoded_wr_biten[1:0]);
            load_next_c = '1;
        end else if(hwif_in.ADAMS_BRIDGE_CTRL.CTRL.hwclr) begin // HW Clear
            next_c = '0;
            load_next_c = '1;
        end
        field_combo.ADAMS_BRIDGE_CTRL.CTRL.next = next_c;
        field_combo.ADAMS_BRIDGE_CTRL.CTRL.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.ADAMS_BRIDGE_CTRL.CTRL.value <= 2'h0;
        end else if(field_combo.ADAMS_BRIDGE_CTRL.CTRL.load_next) begin
            field_storage.ADAMS_BRIDGE_CTRL.CTRL.value <= field_combo.ADAMS_BRIDGE_CTRL.CTRL.next;
        end
    end
    assign hwif_out.ADAMS_BRIDGE_CTRL.CTRL.value = field_storage.ADAMS_BRIDGE_CTRL.CTRL.value;
    // Field: adams_bridge_reg.ADAMS_BRIDGE_CTRL.ZEROIZE
    always_comb begin
        automatic logic [0:0] next_c = field_storage.ADAMS_BRIDGE_CTRL.ZEROIZE.value;
        automatic logic load_next_c = '0;
        if(decoded_reg_strb.ADAMS_BRIDGE_CTRL && decoded_req_is_wr) begin // SW write
            next_c = (field_storage.ADAMS_BRIDGE_CTRL.ZEROIZE.value & ~decoded_wr_biten[2:2]) | (decoded_wr_data[2:2] & decoded_wr_biten[2:2]);
            load_next_c = '1;
        end else begin // singlepulse clears back to 0
            next_c = '0;
            load_next_c = '1;
        end
        field_combo.ADAMS_BRIDGE_CTRL.ZEROIZE.next = next_c;
        field_combo.ADAMS_BRIDGE_CTRL.ZEROIZE.load_next = load_next_c;
    end
    always_ff @(posedge clk or negedge hwif_in.reset_b) begin
        if(~hwif_in.reset_b) begin
            field_storage.ADAMS_BRIDGE_CTRL.ZEROIZE.value <= 1'h0;
        end else if(field_combo.ADAMS_BRIDGE_CTRL.ZEROIZE.load_next) begin
            field_storage.ADAMS_BRIDGE_CTRL.ZEROIZE.value <= field_combo.ADAMS_BRIDGE_CTRL.ZEROIZE.next;
        end
    end
    assign hwif_out.ADAMS_BRIDGE_CTRL.ZEROIZE.value = field_storage.ADAMS_BRIDGE_CTRL.ZEROIZE.value;
    for(genvar i0=0; i0<16; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_IV[].IV
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_IV[i0].IV.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_IV[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_IV[i0].IV.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_IV[i0].IV.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_IV[i0].IV.next = next_c;
            field_combo.ADAMS_BRIDGE_IV[i0].IV.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_IV[i0].IV.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_IV[i0].IV.load_next) begin
                field_storage.ADAMS_BRIDGE_IV[i0].IV.value <= field_combo.ADAMS_BRIDGE_IV[i0].IV.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_IV[i0].IV.value = field_storage.ADAMS_BRIDGE_IV[i0].IV.value;
    end
    for(genvar i0=0; i0<8; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_SEED[].SEED
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_SEED[i0].SEED.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_SEED[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_SEED[i0].SEED.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_SEED[i0].SEED.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_SEED[i0].SEED.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_SEED[i0].SEED.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_SEED[i0].SEED.next = next_c;
            field_combo.ADAMS_BRIDGE_SEED[i0].SEED.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_SEED[i0].SEED.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_SEED[i0].SEED.load_next) begin
                field_storage.ADAMS_BRIDGE_SEED[i0].SEED.value <= field_combo.ADAMS_BRIDGE_SEED[i0].SEED.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_SEED[i0].SEED.value = field_storage.ADAMS_BRIDGE_SEED[i0].SEED.value;
    end
    for(genvar i0=0; i0<8; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_SIGN_RND[].SIGN_RND
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_SIGN_RND[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.next = next_c;
            field_combo.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.load_next) begin
                field_storage.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value <= field_combo.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value = field_storage.ADAMS_BRIDGE_SIGN_RND[i0].SIGN_RND.value;
    end
    for(genvar i0=0; i0<16; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_MSG[].MSG
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_MSG[i0].MSG.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_MSG[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_MSG[i0].MSG.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_MSG[i0].MSG.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_MSG[i0].MSG.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_MSG[i0].MSG.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_MSG[i0].MSG.next = next_c;
            field_combo.ADAMS_BRIDGE_MSG[i0].MSG.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_MSG[i0].MSG.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_MSG[i0].MSG.load_next) begin
                field_storage.ADAMS_BRIDGE_MSG[i0].MSG.value <= field_combo.ADAMS_BRIDGE_MSG[i0].MSG.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_MSG[i0].MSG.value = field_storage.ADAMS_BRIDGE_MSG[i0].MSG.value;
    end
    for(genvar i0=0; i0<16; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_VERIFY_RES[].VERIFY_RES
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value;
            automatic logic load_next_c = '0;
            if(hwif_in.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.next = next_c;
            field_combo.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.load_next) begin
                field_storage.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value <= field_combo.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value = field_storage.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value;
    end
    for(genvar i0=0; i0<1216; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_PRIVKEY_OUT[].PRIVKEY_OUT
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.value;
            automatic logic load_next_c = '0;
            if(hwif_in.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.next = next_c;
            field_combo.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.load_next) begin
                field_storage.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.value <= field_combo.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.next;
            end
        end
    end
    for(genvar i0=0; i0<1216; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_PRIVKEY_IN[].PRIVKEY_IN
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_PRIVKEY_IN[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.next = next_c;
            field_combo.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.load_next) begin
                field_storage.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value <= field_combo.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value = field_storage.ADAMS_BRIDGE_PRIVKEY_IN[i0].PRIVKEY_IN.value;
    end
    for(genvar i0=0; i0<648; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_PUBKEY[].PUBKEY
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_PUBKEY[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.next = next_c;
            field_combo.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.load_next) begin
                field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value <= field_combo.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value = field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value;
    end
    for(genvar i0=0; i0<1149; i0++) begin
        // Field: adams_bridge_reg.ADAMS_BRIDGE_SIGNATURE[].SIGNATURE
        always_comb begin
            automatic logic [31:0] next_c = field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value;
            automatic logic load_next_c = '0;
            if(decoded_reg_strb.ADAMS_BRIDGE_SIGNATURE[i0] && decoded_req_is_wr && hwif_in.adams_bridge_ready) begin // SW write
                next_c = (field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value & ~decoded_wr_biten[31:0]) | (decoded_wr_data[31:0] & decoded_wr_biten[31:0]);
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.we) begin // HW Write - we
                next_c = hwif_in.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.next;
                load_next_c = '1;
            end else if(hwif_in.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.hwclr) begin // HW Clear
                next_c = '0;
                load_next_c = '1;
            end
            field_combo.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.next = next_c;
            field_combo.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.load_next = load_next_c;
        end
        always_ff @(posedge clk or negedge hwif_in.reset_b) begin
            if(~hwif_in.reset_b) begin
                field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value <= 32'h0;
            end else if(field_combo.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.load_next) begin
                field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value <= field_combo.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.next;
            end
        end
        assign hwif_out.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value = field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value;
    end
    // Field: adams_bridge_reg.intr_block_rf.global_intr_en_r.error_en
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.global_intr_en_r.notif_en
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_intr_en_r.error_internal_en
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_intr_en_r.notif_cmd_done_en
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_global_intr_r.agg_sts
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_global_intr_r.agg_sts
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_internal_intr_r.error_internal_sts
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_internal_intr_r.notif_cmd_done_sts
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_intr_trig_r.error_internal_trig
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_intr_trig_r.notif_cmd_done_trig
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_internal_intr_count_r.cnt
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_cmd_done_intr_count_r.cnt
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.error_internal_intr_count_incr_r.pulse
    always_comb begin
    ...
    // Field: adams_bridge_reg.intr_block_rf.notif_cmd_done_intr_count_incr_r.pulse
    always_comb begin
    ...
    for(genvar i0=0; i0<2; i0++) begin
        assign readback_array[i0*1 + 0][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_NAME[i0] && !decoded_req_is_wr) ? hwif_in.ADAMS_BRIDGE_NAME[i0].NAME.next : '0;
    end
    for(genvar i0=0; i0<2; i0++) begin
        assign readback_array[i0*1 + 2][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_VERSION[i0] && !decoded_req_is_wr) ? hwif_in.ADAMS_BRIDGE_VERSION[i0].VERSION.next : '0;
    end
    assign readback_array[4][0:0] = (decoded_reg_strb.ADAMS_BRIDGE_STATUS && !decoded_req_is_wr) ? hwif_in.ADAMS_BRIDGE_STATUS.READY.next : '0;
    assign readback_array[4][1:1] = (decoded_reg_strb.ADAMS_BRIDGE_STATUS && !decoded_req_is_wr) ? hwif_in.ADAMS_BRIDGE_STATUS.VALID.next : '0;
    assign readback_array[4][31:2] = '0;
    for(genvar i0=0; i0<16; i0++) begin
        assign readback_array[i0*1 + 5][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_VERIFY_RES[i0] && !decoded_req_is_wr) ? field_storage.ADAMS_BRIDGE_VERIFY_RES[i0].VERIFY_RES.value : '0;
    end
    for(genvar i0=0; i0<1216; i0++) begin
        assign readback_array[i0*1 + 21][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_PRIVKEY_OUT[i0] && !decoded_req_is_wr) ? field_storage.ADAMS_BRIDGE_PRIVKEY_OUT[i0].PRIVKEY_OUT.value : '0;
    end
    for(genvar i0=0; i0<648; i0++) begin
        assign readback_array[i0*1 + 1237][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_PUBKEY[i0] && !decoded_req_is_wr) ? field_storage.ADAMS_BRIDGE_PUBKEY[i0].PUBKEY.value : '0;
    end
    for(genvar i0=0; i0<1149; i0++) begin
        assign readback_array[i0*1 + 1885][31:0] = (decoded_reg_strb.ADAMS_BRIDGE_SIGNATURE[i0] && !decoded_req_is_wr) ? field_storage.ADAMS_BRIDGE_SIGNATURE[i0].SIGNATURE.value : '0;
    end
