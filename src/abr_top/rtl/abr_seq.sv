  ...
  always_ff @(posedge clk) begin
        if (en_i) begin
            unique case(addr_i)
                ...
                MLKEM_ENCAPS_S  + 12: data_o_rom <= '{opcode:ABR_UOP_MASKED_CBD, imm:'h0004, length:'d33, operand1:MLKEM_R_ID, operand2:ABR_NOP, operand3:MLKEM_E0_BASE};
                MLKEM_ENCAPS_S  + 13: data_o_rom <= '{opcode:ABR_UOP_MASKED_CBD, imm:'h0005, length:'d33, operand1:MLKEM_R_ID, operand2:ABR_NOP, operand3:MLKEM_E1_BASE};
                MLKEM_ENCAPS_S  + 14: data_o_rom <= '{opcode:ABR_UOP_MASKED_CBD, imm:'h0006, length:'d33, operand1:MLKEM_R_ID, operand2:ABR_NOP, operand3:MLKEM_E2_BASE};
                MLKEM_ENCAPS_S  + 15: data_o_rom <= '{opcode:ABR_UOP_MASKED_CBD, imm:'h0007, length:'d33, operand1:MLKEM_R_ID, operand2:ABR_NOP, operand3:MLKEM_E3_BASE};
                MLKEM_ENCAPS_S  + 16: data_o_rom <= '{opcode:ABR_UOP_MASKED_CBD, imm:'h0008, length:'d33, operand1:MLKEM_R_ID, operand2:ABR_NOP, operand3:MLKEM_E_2_BASE};
                ...
                MLKEM_ENCAPS_S  + 26: data_o_rom <= '{opcode:ABR_UOP_MLKEM_MASKED_PWA, imm:'h0000, length:'d00, operand1:MLKEM_UP0_BASE, operand2:MLKEM_E0_BASE, operand3:MLKEM_UP0_BASE};
                ...
                MLKEM_ENCAPS_S  + 32: data_o_rom <= '{opcode:ABR_UOP_MLKEM_MASKED_PWA, imm:'h0000, length:'d00, operand1:MLKEM_UP1_BASE, operand2:MLKEM_E1_BASE, operand3:MLKEM_UP1_BASE};
                ...
                MLKEM_ENCAPS_S  + 38: data_o_rom <= '{opcode:ABR_UOP_MLKEM_MASKED_PWA, imm:'h0000, length:'d00, operand1:MLKEM_UP2_BASE, operand2:MLKEM_E2_BASE, operand3:MLKEM_UP2_BASE};
                ...
                MLKEM_ENCAPS_S  + 44: data_o_rom <= '{opcode:ABR_UOP_MLKEM_MASKED_PWA, imm:'h0000, length:'d00, operand1:MLKEM_UP3_BASE, operand2:MLKEM_E3_BASE, operand3:MLKEM_UP3_BASE};
                ...
                MLKEM_ENCAPS_S  + 50: data_o_rom <= '{opcode:ABR_UOP_MLKEM_MASKED_PWA, imm:'h0000, length:'d00, operand1:MLKEM_V_BASE, operand2:MLKEM_E_2_BASE, operand3:MLKEM_V_BASE};
