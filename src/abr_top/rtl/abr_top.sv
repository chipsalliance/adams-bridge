...
//Signal Declarations
  ...
  logic [ABR_MEM_DATA_WIDTH-1:0] pws_rec_share0;
  logic [ABR_MEM_DATA_WIDTH-1:0] pws_rec_share1;
  logic [ABR_MEM_DATA_WIDTH-1:0] pws_rec_data;
