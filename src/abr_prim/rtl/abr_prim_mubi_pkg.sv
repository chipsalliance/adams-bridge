...
package abr_prim_mubi_pkg;
  ...
  `ABR_ASSERT_STATIC_IN_PACKAGE(CheckMuBi4ValsComplementary_A, MuBi4True == ~MuBi4False)
  ...
  // This is a prerequisite for the multibit functions below to work.
  `ABR_ASSERT_STATIC_IN_PACKAGE(CheckMuBi8ValsComplementary_A, MuBi8True == ~MuBi8False)
  ...
  // This is a prerequisite for the multibit functions below to work.
  `ABR_ASSERT_STATIC_IN_PACKAGE(CheckMuBi12ValsComplementary_A, MuBi12True == ~MuBi12False)
  ...
  // This is a prerequisite for the multibit functions below to work.
  `ABR_ASSERT_STATIC_IN_PACKAGE(CheckMuBi16ValsComplementary_A, MuBi16True == ~MuBi16False)
