...
package adamsbridge_reg_uvm;
   ...
   `include "adamsbridge_reg_covergroups.svh"
    ...
    class adamsbridge_reg extends uvm_reg_block;
        `uvm_object_utils(adamsbridge_reg)
        ...
        rand adamsbridge_reg__ADAMSBRIDGE_PRIVKEY_OUT ADAMSBRIDGE_PRIVKEY_OUT[1216];
        rand adamsbridge_reg__ADAMSBRIDGE_PRIVKEY_IN ADAMSBRIDGE_PRIVKEY_IN[1216];
        ...
        virtual function void build();
            ...
            foreach(this.ADAMSBRIDGE_PUBKEY[i0]) begin
                ...
                this.default_map.add_reg(this.ADAMSBRIDGE_PUBKEY[i0], 'h2900 + i0*'h4);
            end
